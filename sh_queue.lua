...
function Queue:DebugPrint(msg)
    if Queue.Debug then
        msg = "^3ANON-QUEUE: ^0" .. tostring(msg) .. "^7"
        print(msg)
    end
end
...
function Queue:AddToQueue(ids, connectTime, name, src, deferrals)
    ...
    local tmp = {
        ...
        ids = ids,
        name = name,
        priority = Queue:IsPriority(ids) or (src == "debug" and math_random(0, 3)),
        timeout = 0,
        deferrals = deferrals,
...
local function playerConnect(name, setKickReason, deferrals)
    ...
    local card = {
        ...
        ["version"] = "1.3",
       -- ["backgroundImage"] = {
        --    ["url"] = "https://i.imgur.com/YRFf00z.png",
    ...
    while not clicked do Citizen.Wait(0) end

    local randomTime = math.random(1,3)
	local bypass = false
	
	--if (ids[1] == 'steam:110000107256419') then
	--	bypass = true
	--elseif (ids[1] == 'steam:11000010d971daf') then
	--	bypass = true
	--elseif (ids[1] == 'steam:1100001073b63df') then
	--	bypass = true
	--elseif (ids[1] == 'steam:110000109847c72') then
	--	bypass = true
	--elseif (ids[1] == 'steam:11000010b1fc316') then
	--	bypass = true
	--elseif (ids[1] == 'steam:11000013e7fb184') then
	--	bypass = true
--	else
--		bypass = false
--	end
	...
	if not bypass then
		for i = 1, randomTime do -- randomTime do
			deferrals.update('\xE2\x8F\xB3Te rugam sa astepti ' .. tostring(randomTime - i) .. ' secunde.')
			Wait(1000)
		end
	end
